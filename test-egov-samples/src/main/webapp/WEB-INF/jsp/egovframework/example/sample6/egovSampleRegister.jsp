...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_selectList() {
           	document.detailForm.action = "/sample6/egovSampleList.do";
           	document.detailForm.submit();
        }
        
        /* 글 삭제 function */
        function fn_egov_delete() {
           	document.detailForm.action = "/sample6/deleteSample.do";
           	document.detailForm.submit();
        }
        ...
        function fn_egov_save() {
        	...
        	if(!validateSampleVO(frm)){
            	...
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/sample6/addSample.do' : '/sample6/updateSample.do'}"/>";
                frm.submit();
            }
        }
