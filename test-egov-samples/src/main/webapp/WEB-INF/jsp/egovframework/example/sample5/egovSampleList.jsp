    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_select(id) {
        	document.listForm.selectedId.value = id;
           	document.listForm.action = "/sample5/updateSampleView.do";
           	document.listForm.submit();
        }
        
        /* 글 등록 화면 function */
        function fn_egov_addView() {
           	document.listForm.action = "/sample5/addSampleView.do";
           	document.listForm.submit();
        }
        
        /* 글 목록 화면 function */
        function fn_egov_selectList() {
        	document.listForm.action = "/sample5/egovSampleList.do";
           	document.listForm.submit();
        }
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div id="title">
        		<ul>
        			<li><img src="/images/egovframework/example/title_dot.gif" alt=""/> 게시판5</li>
        		</ul>
        	</div>
        	<!-- // 타이틀 -->
        	<div id="search">
