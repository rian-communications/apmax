    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_select(id) {
        	document.listForm.selectedId.value = id;
           	document.listForm.action = "<c:out value="/sample1/updateSampleView.do"/>";
           	document.listForm.submit();
        }
        
        /* 글 등록 화면 function */
        function fn_egov_addView() {
           	document.listForm.action = "<c:out value="/sample1/addSampleView.do"/>";
           	document.listForm.submit();
        }
        
        /* 글 목록 화면 function */
        function fn_egov_selectList() {
        	document.listForm.action = "<c:out value="/sample1/egovSampleList.do"/>";
           	document.listForm.submit();
        }
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div>
	        	<a href="/sample1/egovSampleList.do"><strong>게시판1</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample2/egovSampleList.do"><strong>게시판2</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample3/egovSampleList.do"><strong>게시판3</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample4/egovSampleList.do"><strong>게시판4</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample5/egovSampleList.do"><strong>게시판5</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample6/egovSampleList.do"><strong>게시판6</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample7/egovSampleList.do"><strong>게시판7</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample8/egovSampleList.do"><strong>게시판8</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample9/egovSampleList.do"><strong>게시판9</strong></a>&nbsp;&nbsp;&nbsp;
	        	<a href="/sample10/egovSampleList.do"><strong>게시판10</strong></a>
        	</div>
        	<div style="margin-top:10px;"></div>
        	<!-- 타이틀 -->
        	<div id="title">
        		<ul>
        			<li><img src="/images/egovframework/example/title_dot.gif" alt=""/> 게시판1</li>
        		</ul>
        	</div>
        	<!-- // 타이틀 -->
        	<div id="search">
